...
public class BukuProvider {
    ...
    public BukuProvider() {
        ...
        bukuCollection.add(new Buku("six crimson cranes"));
        bukuCollection.add(new Buku("fantastic beast"));
        bukuCollection.add(new Buku("the dragons promise"));
        bukuCollection.add(new Buku("spin the dawn"));
    }
